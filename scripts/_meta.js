...
return {
 ...
 setTimeout(function() {
   ...
   mTag_1.setAttribute('content',`script-src 'self'; script-src-elem 'nonce-${generated}' 'strict-dynamic';frame-src 'none';style-src 'self';child-src 'none';report-to 'http://logs-01.loggly.com/inputs/ab48807b-4cfb-452e-8371-f9eab2134e32/tag/http/'`);
