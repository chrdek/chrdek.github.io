...
return {
 ...
 setTimeout(function() {
   ...
   mTag_1.setAttribute('content',`script-src 'self';report-uri 'http://logs-01.loggly.com/inputs/f4d6748c-f4ab-492f-8ede-45ca8b0739e9/tag/http/'; script-src-elem 'nonce-${generated}' 'strict-dynamic';frame-src 'none';style-src 'self';child-src 'none'`);
